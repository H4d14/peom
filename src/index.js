...
function generatePoem(event) {
  ...
  let context =
    "You are a romantic Poem expert and love to write short poem, your mission is to generate a 4 line poem in basic HTML, make sure to follow the user instruction. don't write html write jsut the poem";
